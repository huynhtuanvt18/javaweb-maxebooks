...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <c:url var="adminLink" value="${request.contextPath}/admin"/>
        <c:url var="bookLink" value="${request.contextPath}/book"/>

        <c:set var="list" value="${requestScope.requestList}"/>
            ...
            <div id="sidebar">
                <div id="stickThis">
                    <div id="sidebarContent">
                        ...
                        <aside>
                            <div><a class="foo" id="w" href="${adminLink}/books" name="books">Books</a></div>
                            <div><a class="foo" id="w" href="${adminLink}/users" name="users">Users</a></div>
                            <div><a class="foo" id="w" href="${adminLink}/request" name="request">Request</a></div>
            ...
            <div id="main">
                <section id="page">
                    <main>
                        <h1>Request List </h1>
                        <table>
                            <tr><th>ID</th><th>Book Name</th><th>Author Name</th><th>Category</th><th>Upload Date</th><th>Check Book</th><th>Read Check</th><th>Delete</th></tr> 
                            ...
                            <c:forEach var="book" items="${list}">
                                ...
                                <tr style="background-color:${color}">
                                    ...
                                    <td>
                                        <form action="${adminLink}/checked">
                                            <input type="checkbox" value="true" name="check">
                                            <input type="submit" value="check">
                                            <input type="hidden" value="${book.title}" name="title">
                                        </form>
                                    </td>
                                    <td><a href="${bookLink}/read?title=${book.title}"><button type="button">Read</button></a></td>
                                    <td><a href="${adminLink}/delete?bookid=${book.bookID}"><button type="button">Delete</button></a>
                                </tr>
