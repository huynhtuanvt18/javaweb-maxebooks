<%-- 
    Document   : home
    Created on : Mar 17, 2022, 9:38:38 PM
    Author     : admin
--%>
...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <c:url var="adminLink" value="${request.contextPath}/admin/home"/>
        ...
        <div id="wrapall">
            <div id="sidebar">
                <div id="stickThis">
                    <div id="sidebarContent">
                        <a id="logo" href="${homeLink}">Max E-books</a>
                        <aside>
                            <div><a class="foo" id="w" href="${bookLink}/category?category=english" name="english">English</a></div>
                            <div><a class="foo" id="w" href="${bookLink}/category?category=japanese" name="japanese">Japanese</a></div>
                            <div><a class="foo" id="w" href="${bookLink}/category?category=computer" name="computer">Computer</a></div>
                            <div><a class="foo" id="w" href="${bookLink}/category?category=musical" name="musical">Musical</a></div>
                            <div><a class="foo" id="w" href="${bookLink}/category?category=health" name="health">Health</a></div>
                            <a class="back2Top" id="w" href="#">Back to top</a>
                        </aside>
                    </div>
                </div>
            ...
            <div id="main">
                <section id="page">
                    <main>
                        <article>
                            <p1><strong>The online bookstore where books are published publicly (in the PDF Format). Creators & readers can share their works over the platform. Max-EBooks is the website made for those people who find their interests in reading. Books are shared publicly and you can freely choose which one fits you the most.</strong></p1><br>
                            <p2><strong>You can publish your E-BOOKS immediately in just a single touch and share them with your friends. Our online library has an enormous mission to bring people together by using the human knowledge. You can get the access to every book anytime and anywhere. And now: Welcome to Max-EBooks.</strong></p2>
                        </article>
                        <c:forEach var="book" items="${list}">
                            <c:url var="bookDetail" value="${request.contextPath}/book/detail">
                                <c:param name="title" value="${book.title}"/>
                            </c:url>
                            <article>
                                <h2><a href="${bookDetail}" style="font-size:20px; color: red" > ${book.title}</a></h2>
                                <p style="font-size: 12px">author: ${book.author}</p>
                                <p style="font-size: 12px">category: ${book.category}</p>
                                <p style="font-size: 12px; text-align: right">upload date: ${book.uploadDate}</p>
                            </article>
                        </c:forEach>
                    </main>			
                    <footer>
