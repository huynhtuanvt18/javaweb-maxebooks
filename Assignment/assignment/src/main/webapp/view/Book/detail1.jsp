...
<html>
    ...
    <body>
        ...
        <c:url var="commentLink" value="${request.contextPath}/book/comment"/>
            ...
            <div id="main">
                <section id="page">
                    <main>
                        ...
                        <c:url var="bookRead" value="${request.contextPath}/book/read">
                            <c:param name="title" value="${detail.title}"/>
                        </c:url>
                        <c:url var="bookDownload" value="${request.contextPath}/book/download">
                            <c:param name="title" value="${detail.title}"/>
                        </c:url>
                        <p>title:${detail.title}</p>
                        <p>author:${detail.author}</p>
                        <p>date upload:${detail.uploadDate}</p>
                        <p>category:${detail.category}</p>
                        <p></p>
                        <table style="border: 1px solid black; text-align: left" width="400px">
                            <tr><th>Comment</th></tr>
                                    <c:forEach var="comment" items="${commentList}">
                                <tr style="background-color: #ffffff"> <th style="font-size: 13px; fo">${comment}</th></tr>
                                    </c:forEach>
                        </table>
                        <form action="${commentLink}" > 
                            <input type="text" name="cmt">
                            <input value="${detail.title}" name="title" type="hidden">
                            <input value="${detail.bookID}" name="bookId" type="hidden">
                            <input value="${currentAccount.user_id}" name="userId" type="hidden">
                            <input type="submit" value="cmt"> 
                        </form>
                        <a href="${bookRead}">Read Book</a>
                        <a href="${bookDownload}">Download Book</a>
                    </main>			
                    <footer>
